...
export class HospitalService {
  ...
  getAppointments(){
    return this.http.get(this.url+"/getAppointments");
    //returns List of all Doctor;
  }
  ...
  addAppointment(data: any){
    return this.http.post(this.url+'/addAppointment/', data);
  }

  updateAppointment(id: string, s: string)
  {
    return this.http.get(this.url+"/updateAppointment/?id="+id+"&s="+s);
  }
